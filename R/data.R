...
#' \itemize{
#'   \item cogids. A data.frame with 644810 COG IDs.
...
#'   \itemize{
#'     \item Phylogenetic tree with 461 tips and 339 internal nodes describing relations between all Eukaryotes listed in the 'sspids' object.
#'   }
#' }
#' @usage data(gpdata_oma_All.Jun2019)
#' @description Data package used in evolutionary root inference reconstruction containing four objects derived from the OMA database, release of All.Jun2019
#' @keywords datasets
